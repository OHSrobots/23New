...
public class DriveConstants {
     ...
     */
    public static final double TICKS_PER_REV = 1680;//1120;
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(8, 0, 0,13);
    ...
    public static double GEAR_RATIO = 3.267; // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.0245; // rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = 3;//Math.toRadians(30);
    public static double MAX_ANG_ACCEL = 20; //Math.toRadians(30);
